...
//     template: '<a class="feed__effect" href="{{link}}" style="background-image:url({{image}})" target="_blank"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" /></a>'
// });
// userFeed.run();
